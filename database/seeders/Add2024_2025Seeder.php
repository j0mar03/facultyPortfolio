...
class Add2024_2025Seeder extends Seeder
{
    /**
     * SAFELY add 2024-2025 academic year class offerings for all courses.
     * This uses firstOrCreate to ensure existing records are NOT modified.
     * Safe to run on production - will only create missing 2024-2025 entries.
     */
    public function run(): void
    {
        // Get all courses
        $courses = Course::whereIn('code', ['DEET', 'DMET', 'DIT', 'DOMT'])->get();
        ...
        $this->command->info('Done! All 2024-2025 class offerings added (existing data preserved).');
    }
}
