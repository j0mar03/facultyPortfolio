...
1. Workflow efficiency (process organization, status tracking, available operational indicators, and user-perceived turnaround support)
2. Compliance and governance support (required-document completeness, role-based governance, and available traceability/report-readiness indicators)
...
1. **Problem 1: Workflow efficiency**
   ...
   - Measures: processing duration, status-flow indicators, and review-turnaround support (objective turnaround only when review logs are available)
...
2. **Problem 2: Compliance and governance support**
   ...
   - Measures: completeness rates, incomplete submission rates, and available governance/traceability indicators with explicit availability flags
