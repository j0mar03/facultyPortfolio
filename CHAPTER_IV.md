...
## 4.9 Recommended Chapter IV Figures (Mermaid)

The following insertion-ready Mermaid figures are provided in `CHAPTER_IV_DIAGRAMS.md`:

1. Figure 4.1. Chapter IV Experimental Pipeline
2. Figure 4.2. Class Distribution of Final Dataset
3. Figure 4.3. Test-Set Accuracy Comparison
4. Figure 4.4. Recall and False Negative Trade-off
5. Figure 4.5. Brier Score (Calibration Reliability)
6. Figure 4.6. McNemar Pairwise Significance Results
